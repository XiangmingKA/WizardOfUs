...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniBrushInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniBrushInfo")),new UScriptStruct::TCppStructOps<FHoudiniBrushInfo>);
	}
	...
	IMPLEMENT_CLASS(UHoudiniInputLandscape, 134620253);
