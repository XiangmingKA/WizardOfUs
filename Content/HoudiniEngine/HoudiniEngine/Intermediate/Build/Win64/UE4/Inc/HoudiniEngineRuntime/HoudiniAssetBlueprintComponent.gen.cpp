...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniAssetBlueprintInstanceData
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniAssetBlueprintInstanceData")),new UScriptStruct::TCppStructOps<FHoudiniAssetBlueprintInstanceData>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniAssetBlueprintOutput
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniAssetBlueprintOutput")),new UScriptStruct::TCppStructOps<FHoudiniAssetBlueprintOutput>);
	}
	...
	IMPLEMENT_CLASS(UHoudiniAssetBlueprintComponent, 2735670205);
